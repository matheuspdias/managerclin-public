...
export default function CreateMedicalRecord() {
    const page = usePage();
    const { customer, appointments, preselectedAppointment } = page.props as any;
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        },
        {
            ...
            href: `/medical-records/patient/${customer.id}/create`,
        },
    ];

    const { data, setData, post, processing, errors, transform } = useForm({
        id_customer: customer.id,
        id_appointment: preselectedAppointment || 'none',
        chief_complaint: '',
        physical_exam: '',
        diagnosis: '',
        treatment_plan: '',
    ...
    // Exibir mensagem de erro flash do backend (ex: erro de CRM)
    useEffect(() => {
        if (flashError) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Novo Prontuário - ${customer.name}`} />
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end gap-2 pt-6">
                                ...
                                <Button type="submit" disabled={processing}>
                                    ...
                                    {processing ? 'Salvando...' : 'Salvar Prontuário'}
                                </Button>
                            </div>
                        </form>
                    </CardContent>
